package com.vac.manager.service.teamTeamService
...
class TeamServiceTest extends JUnitSuite {
  ...
  //Default variables
  var defaultTeamName: String = _
  var defaultTeamPublicName: String = _
  var defaultTeamFundationalDate: Calendar = _
  var defaultTeamAddress: Address = _
  var defaultTeamWeb: String = _

  object TeamServiceTest {
    @BeforeClass
    def init {
      defaultTeamName = "Test name"
      defaultTeamPublicName = "Test public name"
      defaultTeamFundationalDate = Calendar.getInstance()
      defaultTeamAddress = addressService.createAddress("USA")
      defaultTeamWeb = "www.teamweb.com"
    }
  }
